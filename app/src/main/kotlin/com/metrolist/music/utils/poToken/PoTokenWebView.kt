...
class PoTokenWebView private constructor(
    ...
    private fun loadHtmlAndObtainBotguard(context: Context) {
        if (BuildConfig.DEBUG) {
            Timber.d("loadHtmlAndObtainBotguard() called")
        }
    ...
    fun downloadAndRunBotguard() {
        if (BuildConfig.DEBUG) {
            Timber.d("downloadAndRunBotguard() called")
        }
    ...
    fun onJsInitializationError(error: String) {
        if (BuildConfig.DEBUG) {
            Timber.e("Initialization error from JavaScript: $error")
        }
        ...
        CoroutineScope(Dispatchers.IO).launch(exceptionHandler) {
            ...
            withContext(Dispatchers.Main) {
                webView.evaluateJavascript(
                    ...
                    if (BuildConfig.DEBUG) {
                        Timber.d("initialization finished, expiration=${expirationTimeInSeconds}s")
                    }
    ...
    suspend fun generatePoToken(identifier: String): String {
        if (BuildConfig.DEBUG) {
            Timber.d("generatePoToken() called with identifier $identifier")
        }
    ...
    fun onObtainPoTokenError(identifier: String, error: String) {
        if (BuildConfig.DEBUG) {
            Timber.e("obtainPoToken error from JavaScript: $error")
        }
    ...
    fun onObtainPoTokenResult(identifier: String, poTokenU8: String) {
        if (BuildConfig.DEBUG) {
            Timber.d("Generated poToken (before decoding): identifier=$identifier poTokenU8=$poTokenU8")
        }
        val poToken = try {
        ...
        if (BuildConfig.DEBUG) {
            Timber.d("Generated poToken: identifier=$identifier poToken=$poToken")
        }
     ...
     */
    private suspend fun makeBotguardServiceRequest(url: String, data: String): String = withContext(Dispatchers.IO) {
